  ...
  <div class="order-item">
    ...
    <div class="body">
      ...
      <div class="column state">
        ...
        <!-- <p>{{tabs[order.orderState].label}}</p> -->
        <!-- 待收货：查看物流 -->
        <!-- 待评价：评价商品 -->
        <!-- 已完成：查看评价 -->
        <p @click="$emit('on-logisticsOrderCom',order)" v-if="order.orderState===3"><a href="javascript:;"
...
<script>
  export default {
    ...
    emits: ['on-cancel', 'on-confirm', 'on-logisticsOrderCom'],
    setup(props) {
